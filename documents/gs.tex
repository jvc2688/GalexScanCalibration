...
Therefore to better calibrate the effective exposure of the image.
\ref{flat-profile} shows the profile plots of the sensitivity maps constructed by photons from regions with different photon countrates.
...
However, instead of removing these photons, it is possible to correct 
