...
The original pipeline sensitivity map is not appropriate to be used in the calibration
\begin{enumerate}
\item The 
...
There are more photons cut around the edge than in the center of the detector, which changed the effective response 
\end{enumerate}
