...
if __name__ == '__main__':
    ...
    scans = ['0212','0302','0500','0743','2291','2453']
    scans = ['2759', '2885', '2930', '3155', '3227', '3497']
    scans = ['3155', '3227', '3497']
    scan_f = sys.argv[1]
    scans = []
    ...
    for scan in scans:
        ...
        data = np.zeros((size,size))
        print(scan)
        star = np.load('/scratch/dw1519/galex/data/star_photon/back/'+scan+'_bstar.npy')

        c = SkyCoord(star[:,0]*u.degree, star[:,1]*u.degree, frame='galactic')
        ...
        for name in name_list:
            photon_list.append(np.load('/scratch/dw1519/galex/data/star_photon/back/'+name+'_photon.npy'))
        ...
        np.save('/scratch/dw1519/galex/data/star_photon/back/'+scan+'_data.npy', data)
        np.save('/scratch/dw1519/galex/data/star_photon/back/'+scan+'_exp.npy', exp_list)
