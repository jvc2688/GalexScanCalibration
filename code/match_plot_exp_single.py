...
if __name__ == '__main__':
    if True:
        ...
        for scan in scans:
            ...
            sm, b1 = np.histogram(gl, bins=150, range=ran, weights=dif)
            num, b2 = np.histogram(gl, bins=150, range=ran)
            ...
            plt.savefig('/scratch/dw1519/galex/fits/scan_map/catalog/'+date+'/'+scan+'_match_exp_new.png', dpi=190)
            plt.clf()
            '''
