...
if __name__ == '__main__':
    if True:
        ...
        scans = ['9-19', '18-28', '27-37', '45-55' ]#['9-19']#['0050']#['0-10ds'] #['0050']
        ...
        for scan in scans:
            ...
            for g in group:
                ...
                sm, b1 = np.histogram(glg, bins=250, range=ran, weights=difg)
                num, b2 = np.histogram(glg, bins=250, range=ran)
                ...
                plt.savefig('/scratch/dw1519/galex/fits/scan_map/catalog/'+date+'/'+scan+'_match_exp_new_gb.png', dpi=190)
                plt.clf()
                i+=1
                nrange += 1
                '''
