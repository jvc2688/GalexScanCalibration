...
if __name__ == '__main__':
    ...
    for scan in scans:
        ...
        for name in name_list:
            photon_list.append(np.load('/scratch/dw1519/galex/data/star_photon/'+in_dir+'/'+name+'_photon.npy'))
        ...
        np.save('/scratch/dw1519/galex/data/star_photon/'+out_dir+'/'+scan+'_data.npy', data)
        np.save('/scratch/dw1519/galex/data/star_photon/'+out_dir+'/'+scan+'_exp.npy', exp_list)
